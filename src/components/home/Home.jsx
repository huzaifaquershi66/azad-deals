...
import azaddealing from "../../assets/imgg.jpg"
...
const handleCityClick = (city) => {
  ...
  return (
    <>
<div className="relative w-full h-[400px] rounded-lg flex lg:my-[20px] my-0 items-center justify-center">
  {/* Background Image with Darken Filter */}
  <img
    className="object-cover w-full h-full rounded-lg filter brightness-100" // object-cover ensures the image covers the div without distortion
    src={azaddealing}
    alt="Background"
  />
...
<div className='absolute z-50  inset-0 flex items-center justify-center md:mt-[430px] mt-0'>
...
<div className='absolute inset-0 flex items-center justify-center md:mt-[485px] mt-52 px-4'>
...
{toggleAdvancedSearch && searchCategory === 'Property' && (
  <div className={`md:mt-[510px] z-50 mt-[400px] p-4 border  border-gray-300 ${advancedSearchInput ? 'h-10' : 'h-20'} rounded-lg ${advancedSearchInput ? 'md:w-[500px] w-[300px] ' : ' md:w-[500px] w-[300px]'}} absolute inset-1 bg-white w-4/5 mx-auto flex flex-col items-center`}>
...
{toggleAdvancedSearch && searchCategory === 'Academics' && (
        <div className={`md:mt-[510px] z-50 mt-[400px] p-4 border border-gray-300 ${advancedSearchInput ? 'h-16' : 'h-20'} rounded-lg ${advancedSearchInput ? 'md:w-[500px] w-[300px] ' : ' md:w-[500px] w-[300px]'} absolute inset-1 bg-white w-4/5 mx-auto flex flex-col items-center`}>
          <div className='flex items-center space-x-5'>
            <h3 className='font-helveticaLight text-lg'>Advanced Search</h3>
            <label className="switch">
              <input type="checkbox" onChange={handleAdvancedSearchToggle} />
